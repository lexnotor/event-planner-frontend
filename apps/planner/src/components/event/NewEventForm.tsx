                    ...
                    <tr>
                        ...
                        <td>
                            <input
                                ...
                                type="text"
                                className="w-[30rem] border rounded-l-full rounded-r-full border-primary-200  px-4 py-2 focus:outline-none bg-transparent"
                            />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea
                                ...
                                className="resize-none w-[30rem] border rounded-2xl border-primary-200  px-4 py-2 focus:outline-none bg-transparent"
                            />
                        </td>
                    </tr>
                </tbody>

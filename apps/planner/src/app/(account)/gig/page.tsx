...
const Page = () => {
    return (
        <div className="p-4">
            <div className="bg-[#6b718d]/10 p-4 rounded-xl min-h-[calc(100vh-2rem)]">
                <h1 className="mb-4 text-2xl font-light">Mes services</h1>
                <section className="mb-4 p-4 border border-sky-700/30 rounded-xl flex gap-4 justify-center items-center">
                ...
                <section className="mb-4 p-4 border border-sky-700/30 rounded-xl">
